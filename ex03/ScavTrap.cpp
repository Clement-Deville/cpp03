...
/*   Updated: 2024/10/24 17:04:51 by cdeville         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\e[0;32mScavTrap Copy assignement operator called\e[0m" << std::endl;;
	if (this == &Cpy)
		return (*this);
	this->ClapTrap::operator=(Cpy);
	this->_name = Cpy._name + "_Cpy";
...
void	ScavTrap::print_names(void)
{
	std::cout << this->_name << " adress: " << &this->_name << std::endl;
	std::cout << this->ClapTrap::_name << " adress: " << &this->ClapTrap::_name  << std::endl;
}
