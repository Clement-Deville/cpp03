...
/*   Updated: 2024/10/17 18:14:19 by cdeville         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\e[0;32mClapTrap Default constructor called\e[0m" << std::endl;
	this->_name = "";
	this->_hit_point = 10;
...
{
	std::cout << "\e[0;32mClapTrap Name constructor called\e[0m" << std::endl;
	this->_name = name;
	this->_hit_point = 10;
	this->_energy_point = 10;
	this->_attack_dmg = 0;
